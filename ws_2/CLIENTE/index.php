	...
	<div class="container">
		...
		<div>
			<form action="index.php" method="post" >
				<input type="text" placeholder="Ingrese un n&uacute;mero ENTERO" name="txtNumero" style="width:250px" />
				<br/>
				<input type="submit" value="Calcular Cubo" />
			</form>
		</div>
	<?php
...
//2.- INDICAMOS URL DEL WEB SERVICE
		$host = 'http://localhost:8080/ClaseOnce/ws_2/SERVIDOR/testWS.php';
...
//4.- INVOCAMOS AL METODO SOAP, PASANDOLE EL PARAMETRO DE ENTRADA
		$result = $client->call('ObtenerCubo', array($_POST["txtNumero"]));
